...
Name: softhsm
Version: 2.6.1
Release: %{?prever:0.}13%{?prever:.%{prever}}%{?dist}.3
...
%changelog
* Mon Jan 06 2025 Azure Linux Packaging Team <azurelinux@microsoft.com> - 2.6.1-13.3
- rebuilt

* Mon Jan 06 2025 Azure Linux Packaging Team <azurelinux@microsoft.com> - 2.6.1-13.2
- rebuilt
